					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Segundo App GAR",
									"targetURL": "#zgarapp001-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zgarapp001-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgarapp001",
									"url": sap.ui.require.toUrl("zgarapp001")
								}
							}
						}
					}
